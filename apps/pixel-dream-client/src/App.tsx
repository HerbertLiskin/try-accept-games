...
function App() {
  ...
  return (
    <>
      ...
      <div ref={containerRef} className="max-w-[100vw] mx-auto text-center flex flex-col justify-center items-center h-screen w-screen overflow-hidden relative z-10 bg-black">
        <button 
